...
import {getExpenses, getDeposits, loadMoreExpenses, loadMoreDeposits} from '../../../actions'
...
const AllTransactions = ({expenses, expenseLoading, getExpenses, loadMoreExpenses, loadMoreDeposits, deposits, depositLoading, getDeposits, strings}) => {
...
export default compose(
    connect(mapStateToProps, {getExpenses, getDeposits, loadMoreExpenses}),
    WithTranslation
)(AllTransactions)